...
published: true
exclusive: false
excerpt: Decisões técnicas para apps de delivery — rastreamento real-time com WebSockets, geolocalização em background, notificações de status e gestão de pedidos.
hreflang_pair:
  - locale: 'it-IT'
