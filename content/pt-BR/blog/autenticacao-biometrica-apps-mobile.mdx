...
published: true
exclusive: false
excerpt: Como implementar autenticação biométrica em apps React Native — expo-local-authentication, fallback para PIN, armazenamento seguro de tokens e UX de login.
hreflang_pair:
  - locale: 'it-IT'
