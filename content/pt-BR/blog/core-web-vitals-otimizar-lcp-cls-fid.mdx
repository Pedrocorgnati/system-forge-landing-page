...
published: true
exclusive: false
excerpt: Como otimizar LCP, CLS e INP em sites Next.js e estáticos — técnicas de lazy loading, font swap, layout shift e interatividade com exemplos de código.
hreflang_pair:
  - locale: 'it-IT'
