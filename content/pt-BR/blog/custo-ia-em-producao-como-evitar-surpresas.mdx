...
- **Modelos menores para tarefas simples:** GPT-4o mini ou Claude Sonnet são 5-10x mais rápidos para classificação, triagem e resumos curtos.
...
|--------|-------------------|---------------|
| Classificação de intenção | GPT-5 mini / Claude 4 Sonnet | 1x |
