...
|--------|-------------------|---------------|
| Classificação de intenção | GPT-4o mini / Haiku | 1x |
| Resumo de documentos | GPT-4o mini | 1x |
| Geração de resposta final | GPT-4o / Claude Sonnet | 10-20x |
| Análise jurídica / médica | Claude Opus / GPT-4o | 30-50x |
