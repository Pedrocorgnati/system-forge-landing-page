...
published: true
exclusive: false
excerpt: Como aplicar Scrum e Kanban em projetos de software reais — cerimônias, ferramentas, quando cada método funciona melhor e como adaptar para times pequenos.
hreflang_pair:
  - locale: 'it-IT'
