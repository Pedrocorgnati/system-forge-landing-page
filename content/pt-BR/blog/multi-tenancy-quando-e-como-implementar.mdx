...
published: true
exclusive: false
excerpt: Os três modelos de multi-tenancy (banco compartilhado, schema por tenant, banco por tenant) — quando usar cada um e como migrar entre eles sem downtime.
hreflang_pair:
  - locale: 'it-IT'
