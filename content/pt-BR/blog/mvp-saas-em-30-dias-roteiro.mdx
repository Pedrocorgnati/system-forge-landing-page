...
published: true
exclusive: false
excerpt: Como construir um MVP de SaaS em 30 dias sem cortar o que importa — escolha de stack, features do escopo mínimo, auth, billing básico e primeiros usuários.
hreflang_pair:
  - locale: 'it-IT'
