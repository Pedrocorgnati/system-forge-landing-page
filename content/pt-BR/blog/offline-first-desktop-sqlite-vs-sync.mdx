...
published: true
exclusive: false
excerpt: "Arquitetura offline-first para apps desktop: SQLite local com better-sqlite3, sincronização com servidor e resolução de conflitos em ambiente sem internet."
hreflang_pair:
  - locale: 'it-IT'
