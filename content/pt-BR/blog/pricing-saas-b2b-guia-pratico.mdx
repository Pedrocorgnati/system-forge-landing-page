...
```
Até 5 usuários:   R$ 219/usuário/mês
6 a 20 usuários:  R$ 179/usuário/mês
21 a 50 usuários: R$ 149/usuário/mês
...
```
Licença anual (50 usuários): R$ 92.000/ano
Implementação e onboarding:  R$ 14.000 (one-time)
Suporte Premium (SLA 4h):     R$ 11.000/ano
---
Total ano 1:                  R$ 117.000
Renovação ano 2+:             R$ 103.000/ano
```
...
|--------|----------|-------|
| Starter | 10.000 créditos/mês | R$ 99/mês |
| Growth | 50.000 créditos/mês | R$ 399/mês |
