...
published: true
exclusive: false
excerpt: Como usar Python para automação robótica de processos sem precisar de UiPath ou Automation Anywhere — Playwright, Selenium e PyAutoGUI com exemplos reais.
hreflang_pair:
  - locale: 'it-IT'
