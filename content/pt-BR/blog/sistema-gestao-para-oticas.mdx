...
published: true
exclusive: false
excerpt: "Requisitos de software de gestão para óticas: cadastro de receitas ópticas, histórico do cliente, controle de armações/lentes e integração com laboratórios."
hreflang_pair:
  - locale: 'it-IT'
