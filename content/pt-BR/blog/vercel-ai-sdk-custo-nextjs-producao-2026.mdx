...
coverImage: "/images/blog/vercel-ai-sdk-custo-nextjs-producao-2026.png"
...
2. **Modelos mais baratos para tarefas simples.** GPT-4o mini custa US$ 0,15/1M tokens de input. Claude Sonnet 3.5 custa US$ 0,80/1M. Para classificação, extração e respostas curtas, mini/sonnet entregam 95% da qualidade do modelo grande por 5% do preço.
...
2. **Usar modelo grande para tudo.** Solução: roteamento por complexidade da tarefa. Classificação, parsing e resposta curta vão para mini/sonnet; raciocínio complexo, geração longa ou multi-step vai para sonnet/4o.
