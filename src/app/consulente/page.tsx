...
const whatsappCTA = buildWhatsAppCTA(messages.sections.advisorTeaser.talkToTeam, 'consulente-page')
...
export default function ConsulentePageIT() {
  return (
    <>
      <div
        data-testid="page-consulente"
