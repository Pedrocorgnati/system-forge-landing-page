...
function buildWhatsAppUrl(number: string, locale: string): string {
  const messages: Record<string, string> = {
    'pt-BR': 'Olá! Vi o site e gostaria de conversar sobre um projeto.',
    'it-IT': 'Ciao! Ho visto il sito e vorrei parlare di un progetto.',
    'en': 'Hi! I saw your website and would like to talk about a project.',
    'es-ES': '¡Hola! Vi el sitio y me gustaría hablar sobre un proyecto.',
  }
  const text = encodeURIComponent(messages[locale] ?? messages['en']!)
