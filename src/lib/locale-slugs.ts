 ...
 *   - ROUTE_SLUGS cobre 8 rotas institucionais × 3 locales
 *   - SERVICE_SLUGS cobre todas as chaves de ServiceCategory × 3 locales
...
// ---------------------------------------------------------------------------
// SERVICE_SLUGS — todas as chaves de ServiceCategory × 3 locales
