/**
 * Cenário: Blog — Listagem de Artigos (/blog)
 * Tipo: Página estática — lista de artigos MDX, categoria principal de tráfego orgânico
...
export const options = {
  ...
  tags: {
    ...
    scenario: __ENV.SCENARIO || 'blog-listing',
  },
}
...
export default function () {
  ...
  const ok = check(res, {
    ...
    'blog latência < SLO p95': (r) => r.timings.duration < SLO_P95,
  })
